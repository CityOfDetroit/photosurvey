...
var surveyModule = function () {
  var survey = {
    ...
    questionsList: ['Does this parcel need intervention?', 'Is the blighted parcel a lot or structure?', 'Structure with Blight', 'Elements of the Blighted Structure (select all that apply)', 'Elements of the Blighted Lot (select all that apply)'],
    answerList: [[{
      text: 'No',
      value: 'n',
