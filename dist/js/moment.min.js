...
!function (a, b) {
  ...
  function b(a) {
    ...
    for (var c in b) i(b, c) && (a[c] = b[c]);return i(b, "toString") && (a.toString = b.toString), i(b, "valueOf") && (a.valueOf = b.valueOf), a;
  }function k(a, b, c, d) {
  ...
  function v(a, b, c) {
    ...
    var c,
        e = j({}, a);for (c in b) i(b, c) && (d(a[c]) && d(b[c]) ? (e[c] = {}, j(e[c], a[c]), j(e[c], b[c])) : null != b[c] ? e[c] = b[c] : delete e[c]);for (c in a) i(a, c) && !i(b, c) && d(a[c]) && (
    ...
    var b,
        c,
        d = {};for (c in a) i(a, c) && (b = K(c), b && (d[b] = a[c]));return d;
  }function M(a, b) {
    Ed[a] = b;
  }function N(a) {
    var b = [];for (var c in a) b.push({ unit: c, priority: Ed[c] });return b.sort(function (a, b) {
  ...
  function U(a, b, c, d) {
    ...
    var b,
        c,
        d = a.match(Fd);for (b = 0, c = d.length; b < c; b++) Id[d[b]] ? d[b] = Id[d[b]] : d[b] = V(d[b]);return function (b) {
      var e,
          f = "";for (e = 0; e < c; e++) f += d[e] instanceof Function ? d[e].call(b, a) : d[e];return f;
    };
  }
  ...
  function X(a, b) {
    ...
    }var d = 5;for (Gd.lastIndex = 0; d >= 0 && Gd.test(a);) a = a.replace(Gd, c), Gd.lastIndex = 0, d -= 1;return a;
  }function Z(a, b, c) {
  ...
  function _(a) {
    ...
    var c,
        d = b;for ("string" == typeof a && (a = [a]), f(b) && (d = function (a, c) {
      c[b] = u(a);
  ...
  function kb(b) {
    ...
    var c,
        ...
        h = "" + b._i,
        i = h.length,
        j = 0;for (e = Y(b._f, b._locale).match(Fd) || [], c = 0; c < e.length; c++) f = e[c], d = (h.match($(f, b)) || [])[0],
  ...
  function tb(a, b) {
    var d, e;if (1 === b.length && c(b[0]) && (b = b[0]), !b.length) return sb();for (d = b[0], e = 1; e < b.length; ++e) b[e].isValid() && !b[e][a](d) || (d = b[e]);return d;
  }
  ...
  function Jc() {
    ...
    if (f(a) && (b = a, a = void 0), a = a || "", null != b) return Oc(a, b, c, "month");var d,
        e = [];for (d = 0; d < 12; d++) e[d] = Oc(a, d, c, "month");return e;
  }
  // ()
  // (5)
  // (fmt, 5)
  ...
  function Qc(a, b, c, d) {
    "boolean" == typeof a ? (f(b) && (c = b, b = void 0), b = b || "") : (b = a, c = b, a = !1, f(b) && (c = b, b = void 0), b = b || "");var e = bb(),
        ...
        i = [];for (h = 0; h < 7; h++) i[h] = Oc(b, (h + g) % 7, d, "day");return i;
  }function Rc(a, b) {
  ...
  function ld(a, b) {
    ...
    var b,
        c = [];for (b in a) i(a, b) && c.push(b);return c;
  };var vd,
      wd = ud,
  ...
  // Hours
  Ye.isPM = Va, Ye.meridiem = Wa, $a("en", { ordinalParse: /\d{1,2}(th|st|nd|rd)/, ordinal: function (a) {
      var b = a % 10,
